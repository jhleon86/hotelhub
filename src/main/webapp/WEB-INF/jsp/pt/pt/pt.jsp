...
<div style="text-align:center;">
	<div class="parent" style="width:1245px; ">
		...
		<span>step2. soldout 확인(쿠팡)</span>
		<button id="button_cp_refresh" type="button">새로고침</button>
		<iframe id="iframe_cp" style="width: 414px ; height: 736px; border: none;" src="pt/cp/cp1_1">
		</iframe>
		</div>
		<div class="child right">
		<span>step2. soldout 확인(노랑풍선)</span>
		<button id="button_np_refresh" type="button">새로고침</button>
